...
public class TransitiveObjectProperty extends AbstractAxiom implements ObjectPropertyAxiom {
    ...
    public String toTurtleString(Prefixes prefixes, Identifier mainNode) {
        ...
        buffer.append(writeSingleMainTripleAxiom(prefixes, subject, Vocabulary.RDF_TYPE, Vocabulary.OWL_TRANSITIVE_PROPERTY, m_annotations));
        return buffer.toString();
    }
    ...
    public static TransitiveObjectProperty create(ObjectPropertyExpression objectPropertyExpression, Annotation... annotations) {
