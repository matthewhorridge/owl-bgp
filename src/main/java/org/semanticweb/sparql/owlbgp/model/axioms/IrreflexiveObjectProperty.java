...
public class IrreflexiveObjectProperty extends AbstractAxiom implements ObjectPropertyAxiom {
    ...
    public String toTurtleString(Prefixes prefixes, Identifier mainNode) {
        ...
        buffer.append(writeSingleMainTripleAxiom(prefixes, subject, Vocabulary.RDF_TYPE, Vocabulary.OWL_IRREFLEXIVE_PROPERTY, m_annotations));
        return buffer.toString();
    }
    ...
    public static IrreflexiveObjectProperty create(ObjectPropertyExpression objectPropertyExpression, Annotation... annotations) {
