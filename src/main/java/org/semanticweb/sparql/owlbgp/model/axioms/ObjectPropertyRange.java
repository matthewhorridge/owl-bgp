...
public class ObjectPropertyRange extends AbstractAxiom {
    ...
    public String toTurtleString(Prefixes prefixes, Identifier mainNode) {
        ...
        buffer.append(writeSingleMainTripleAxiom(prefixes, subject, Vocabulary.RDFS_RANGE, object, m_annotations));
        return buffer.toString();
    }
